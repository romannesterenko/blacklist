        ...
        <div class="row">
            ...
            <div class="col-md-6 p-4">
                <form class="needs-validation check_buyer">
                    ...
                    <div class="row g-3 py-2">
                        <div class="col-12">
                            <label for="lastName" class="form-label py-1 fw-bold">Nazwisko kupującego</label>
                            <span class="d-flex">
                                <div class="form-check py-1">
            ...
            <form class="needs-validation" id="add_black_list">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="col py-2">
                            <label for="firstName" class="form-label">Imię kupującego <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="firstName" placeholder="Imię kupującego" name="name" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="col py-2">
